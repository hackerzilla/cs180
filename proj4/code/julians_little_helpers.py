...
def DisplayImages(ims, titles, size):
    """
    Assumes ims is a list of images.
    Assumes titles is a list of titles.
    Assumes size is an integer.
    """
    # Set the desired width and height for the figure
    fig_width = len(ims) * size# Width in inches
    fig_height = size # Height in inches

    # Create a figure with three subplots and set the figsize
    fig, axs = plt.subplots(1, len(ims), figsize=(fig_width, fig_height))
